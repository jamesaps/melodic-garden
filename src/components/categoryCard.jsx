function categoryCards() {
    return (
        ...
        <div className="max-w-sm bg-white rounded-lg p-a mx-2 my-4 justify items-center ">
            <a href="#">
                <img className="rounded-3xl mb-4 w-full h-80 hover:opacity-80" src="https://img.freepik.com/free-photo/popular-potted-houseplants-white-background_53876-127000.jpg?w=1380&t=st=1710365315~exp=1710365915~hmac=f3055e21728a0253c7d4b9d2b9097b0466521cc5e912cb0c8ed55f4d168810f2" alt="" />
        ...
        <div className="max-w-sm bg-white rounded-lg p-a mx-2 my-4 align-center items-center ">
            <a href="#">
        ...
        <div className="max-w-sm bg-white rounded-lg p-a mx-2 my-4 items-center ">
            <a href="#">
