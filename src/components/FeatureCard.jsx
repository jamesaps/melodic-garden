...
function CategoryCard() {
  return (
      ...
      <div className="p-4 mb-4 rounded-3xl drop-shadow-xl h-40 md:h-full w-full flex items-end bg-none " style={{backgroundImage:`url(${FeatureImage})`}}>
        <div className="md:pl-5 pl-0 w-full">
        <h2 className="text-black-900 mb-6 font-bold text-4xl md:text-3xl lg:text-6xl uppercase md:normal-case text-center md:text-left">
          Featured Plants
        </h2>
        <p
