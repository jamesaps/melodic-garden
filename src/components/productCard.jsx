        ...
        <div className="max-w-sm bg-white rounded-lg p-a">
          <a href="#">
            ...
            <div className="flex items-center justify-between mt-8">
              <span className="text-md md:text-xl lg:text-2xl text-gray-900 dark:text-white ml-7 mb-5">Calathea</span>
              <span className="text-md md:text-xl lg:text-2xl font-bold text-gray-900 dark:text-white mr-7 mb-5">£25.00</span>
            </div>
          </a>
        </div>
      );
